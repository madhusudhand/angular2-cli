...
class Build extends Task {
  ...
  copy() {
    ...
    this.ui.startProgress('Copying vendor and third party libraries');
    return copy.run({})
      .finally(() => {
        this.ui.stopProgress();
      })
      .then(() => {
        this.ui.writeSuccess('Copied vendor and third party libraries.');
        return Promise.resolve();
      })
      .catch(() => {
        this.ui.writeError('Error copying vendor and/or third party libraries.');
        return Promise.reject();
      });
  }
